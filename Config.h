...
#define MIN_KEYS_AND_VALUES_FOR_PURCHASED_LIST 0
#define MAX_KEYS_AND_VALUES_FOR_PURCHASED_LIST 10
#define MIN_KEYS_AND_VALUES_FOR_RATE 4
#define MAX_KEYS_AND_VALUES_FOR_RATE 4
#define MIN_KEYS_AND_VALUES_FOR_COMMENT 4
#define MAX_KEYS_AND_VALUES_FOR_COMMENT 4
#define MIN_KEYS_AND_VALUES_FOR_COMMENT_REPLY 6
#define MAX_KEYS_AND_VALUES_FOR_COMMENT_REPLY 6
#define MIN_KEYS_AND_VALUES_FOR_COMMENT_DELETE 4
#define MAX_KEYS_AND_VALUES_FOR_COMMENT_DELETE 4
#define MAX_KEYS_AND_VALUES_FOR_ALL_NOTIFICATIONS 2
#define MIN_KEYS_AND_VALUES_FOR_ALL_NOTIFICATIONS 2
